...
//
//    @PostMapping("/{portfolioId}/api-generation")
...
//        4. data[0].design 로 접근하면 다이어그램 정보를 가져올 수 있어야 돼
...
//                    String plantUmlSource = (String) module.get("design");
//
//                    System.out.println(plantUmlSource);
//
//                    try (FileOutputStream png = new FileOutputStream("diagram"+i+".png")){
//                        SourceStringReader reader = new SourceStringReader(plantUmlSource);
//                        reader.outputImage(png,new FileFormatOption(FileFormat.PNG));
//                        System.out.println("생성 완");
//                    } catch (IOException e) {
//                        throw new IllegalStateException("diagram image generate fail");
//                    }
//                }
//            }
//
